...
class  SEEDIV_dataset(Dataset):
    def __init__(self, SEEDIV_data_dir, subj_num, session_num, is_train):
        ...
        self.channel_group1 = [2 ,1 ,3, 4, 63, 5, 59, 60, 61] #9 [63]
        self.channel_group2 = [6 ,7 ,8, 15, 16, 17, 24, 25, 26 ] #9
        self.channel_group3 = [33, 34, 35, 42, 43, 44 , 64, 65, 66] #9 [64, 65, 66]
        self.channel_group4 = [12, 13, 14, 21, 22, 23, 30, 31, 32]#9 
        self.channel_group5 = [39, 40, 41, 48, 49, 50, 67, 68, 69]#9 [67, 68, 69]
        self.channel_group6 = [ 9, 10, 11, 18, 19, 20, 27, 28, 29, 36, 37, 38, 45, 46, 47, 70]#16 [70]
        self.channel_group7 = [51, 52, 53, 54, 55, 56, 57, 58, 62] #9
...
if __name__== "__main__":
    ...
    for step, data in enumerate(data_loader, start=0):
        ...
        print(step, data['region1'].size(), data['region2'].size(),data['region3'].size(),data['region4'].size(),data['region5'].size(),
            data['tran_fea1'].size(),labels.size())
        break
