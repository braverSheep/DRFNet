...
class  SEEDIV_dataset(Dataset):
    def __init__(self, SEEDIV_data_dir, subj_num, session_num, is_train):
        ...
        self.channel_group1 = [1, 4, 9, 10, 18, 20, 21, 38, 45, 46, 47, 48, 55, 57, 61, 62] #16 
        self.channel_group2 = [6, 19, 33, 34, 40, 41, 42, 43, 44, 50, 52, 54, 56, 58, 59, 63]  #15 1[63] 16
        self.channel_group3 = [14, 15, 16, 17, 23, 24, 25, 26, 29, 31, 32, 35, 39, 49, 51, 64] #15 1[64] 16
        self.channel_group4 = [2, 3, 5, 7, 8, 27, 28, 36, 37] #9 
        self.channel_group5 = [11, 12, 13, 22, 30, 53, 60, 65, 66] #7 2[65, 66] 9
