...
if __name__ == '__main__':
    ...
    for cross_validation in ([0, 1, 2, 3, 4]):
        ...
        for i in range(1, 16):
            ...
            with open(log_file, 'a') as file:  
                file.write(f'\n---------------------------------------------------------------------start subect:{i}---------------------------------------------------------------------\n ')
            best_model_acc, best_epoch = train_subject(num_subj=i, session_num=3, batch_size=batch_size, lr=lr, epochs=epoch, T_max=T_max, drop_rate=drop_rate,cross_validation=cross_validation)
