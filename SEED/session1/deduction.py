...
if __name__ == '__main__':
    ...
    n_classes = 4
    class_labels = ['SA', 'NE', 'HA']
    colors = ['#ffb347', '#aec6cf', '#cdb4db']
    ...
    print(y_true_bin.ravel().shape, y_true.shape)
    ...
    # plt.title('PR Curve: SEED', fontsize=16)
    plt.legend(loc='best', fontsize=14)
    plt.grid(alpha=0.5)
    plt.tight_layout()
    plt.savefig(r'D:\research\文章\multi_region\new paper\pr_seeds.png', dpi=300)
    plt.show()
